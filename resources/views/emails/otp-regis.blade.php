...
<html>
    <body style="font-family: Arial, sans-serif; text-align: center;">
        ...
        <p style="font-size: 16px; color: #555;">Your OTP code for email verification is:</p>
        ...
        <p style="font-size: 12px; color: #888;">Please use the code above to verify your email address.</p>
    </body>
</html>
